<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="catalogue_view_summer.aspx.cs" Inherits="Rudra_Apparels_WEB.catalogue_view" %>
        ...
        <tr>
            <td>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=&quot;|DataDirectory|\rudra apparels.mdf&quot;;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [products] WHERE ([season] = @season)">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="SUMMER" Name="season" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
            <td>&nbsp;</td>
